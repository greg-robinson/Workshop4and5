      ...
      <div className="panel-footer">
        ...
        <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
          ...
          data.comments.map((comment, i) => {
            ...
            return (
              <Comment key={i} index={i} parent={data._id} commentLikeCounter={comment.commentLikeCounter} author={comment.author} postDate={comment.postDate}>{comment.contents}</Comment>
            );
          })
          }
        </CommentThread>
